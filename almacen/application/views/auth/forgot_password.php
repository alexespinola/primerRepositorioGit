  ...
  <body>
    ...
    <div class="contenedor">
      <header>
        ...
        <div class="nav_login"> <p> RECUPERAR CONTRASEÑA </p> </div>
      </header>
      ...
      <form class="contenedor-login" role="form" method="post" action="auth/login">
        ...
        <button type="submit" class="btn-login" style="margin-bottom:5px;" name="boton">ENVIAR</button>

        <button href="auth/login" class="btn-login" style="margin-bottom:5px;" name="boton">VOLVER</button>
